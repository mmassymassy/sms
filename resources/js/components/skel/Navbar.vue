<template>
    <header class="header" id="header">
        <div @click="showNav" class="header_toggle"> <i class='bx bx-menu' id="header-toggle"></i> </div>
    </header>
        ...
        <nav class="nav">
            <div>
                <a href="#" class="nav_logo">
                    ...
                    <span class="nav_logo-name">SolveMySheet</span>
                </a>
                <div class="nav_list">
                    <router-link to="/dashboard" class="nav_link active">
                        <i class='bx bx-grid-alt nav_icon'></i>
                        <span class="nav_name">Dashboard</span>
                    </router-link>
                    <router-link to="/user" active-link="active" class="nav_link">
